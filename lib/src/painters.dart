...
Path _buildSmoothNotchedPath(
  ...
  final double heightScale = (h / 64.0).clamp(0.75, 1.4).toDouble();
...
class NotchedNavBorderPainter extends CustomPainter {
  ...
  bool shouldRepaint(covariant NotchedNavBorderPainter old) =>
      old.notchCenterX != notchCenterX || old.borderColor != borderColor;
}
...
class NavShadowPainter extends CustomPainter {
  ...
  NavShadowPainter({
    ...
    required this.notchRadius,
    required this.notchCenterX,
    this.shadowColor = Colors.black, // ← default
    this.shadowBlur = 12.0, // ← default
  });
